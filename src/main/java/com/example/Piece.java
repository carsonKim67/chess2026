...
public class Piece {
    ...
    //pre con - the piece is on the square start, and the board is in some configuration
    //post con - returns an arraylist of squares which this piece could legally move to
    ...
    //bishop is allowed to move diagonally in all four directions until it hits a piece or the edge of the board. It can capture an enemy piece by moving onto its square, but cannot move onto a square occupied by a friendly piece.
    //pre con - the piece is on the square start, and the board is in some configuration
    //post con - returns an arraylist of squares which this piece could legally move to
